...
func NewAuthHandler(authService Service, cookieMgr CookieManager) *AuthHandler {
	return &AuthHandler{
...
func (h *AuthHandler) OAuthCallback(c *gin.Context) {
	...
	if err != nil {
		if errors.Is(err, ErrOAuthProviderNotConfigured) {
...
func (h *AuthHandler) metadataFromContext(c *gin.Context) Metadata {
	return Metadata{
...
func (h *AuthHandler) handleAuthSuccess(c *gin.Context, status int, resp *AuthResponse) {
	if h.cookieMgr != nil {
