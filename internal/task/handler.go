...
func (h *TaskHandler) CreateTask(c *gin.Context) {
	...
	req := CreateTaskRequest{ColumnID: &columnID}
...
func (h *TaskHandler) UpdateAssignees(c *gin.Context) {
	...
	var req UpdateTaskAssigneesRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TaskHandler) AddComment(c *gin.Context) {
	...
	req := CreateTaskCommentRequest{TaskID: taskID}
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TaskHandler) AddAttachment(c *gin.Context) {
	...
	req := CreateAttachmentRequest{TaskID: taskID}
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
